...
后续更新已补齐额外维度的群系底图，见 [更多维度群系说明](../reference/additional-dimension-biomes.md)。下文保留 v39 的原始行为记录。
...
新增 24 个入口包含废土世界（Everglades）、Ross 128ba、Triton、Oberon、Titan、Callisto、Ganymede、
